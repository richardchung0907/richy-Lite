...
abstract class EditorInitConfigs {
  ...
  const EditorInitConfigs({
    ...
    this.activeFilterOpacity,
  });

  /// The name of the active filter to pre-select when opening the filter editor.
  final String? activeFilterName;

  /// The opacity of the active filter to restore when opening the filter editor.
  final double? activeFilterOpacity;
